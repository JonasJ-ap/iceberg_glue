...
object GlueApp {
    def main(sysArgs: Array[String]): Unit = {
        ...
        val spark: SparkSession = SparkSession.builder.
          ...
          config("spark.sql.catalog.demo.client.assume-role.session-name", "testApache").
          ...
          config("spark.sql.catalog.demo.http-client.apache.connection-timeout-ms", "10000").
          config("spark.sql.catalog.demo.http-client.apache.socket-timeout-ms", "5000").
          config("spark.sql.catalog.demo.http-client.apache.connection-acquisition-timeout-ms", "5010").
          config("spark.sql.catalog.demo.http-client.apache.connection-max-idle-time-ms", "5001").
          config("spark.sql.catalog.demo.http-client.apache.connection-time-to-live-ms", "5002").
          config("spark.sql.catalog.demo.http-client.apache.expect-continue-enabled", "true").
          config("spark.sql.catalog.demo.http-client.apache.max-connections", "10").
          config("spark.sql.catalog.demo.http-client.apache.tcp-keep-alive-enabled", "true").
          config("spark.sql.catalog.demo.http-client.apache.use-idle-connection-reaper-enabled", "false").
          getOrCreate()
        ...
        val book_reviews_location = "s3://amazon-reviews-pds/parquet/product_category=Books/*.parquet"
            ...
            book_reviews.writeTo("demo.reviewsjonas.book_reviews_apache_http").
