...
object GlueApp {
  def main(sysArgs: Array[String]): Unit = {
    ...
    val spark: SparkSession = SparkSession.builder
      ...
      .config(
        "spark.sql.catalog.demo.http-client.urlconnection.connection-timeout-ms",
        "10000"
      )
      .config(
        "spark.sql.catalog.demo.http-client.urlconnection.socket-timeout-ms",
        "5000"
      )
      .getOrCreate()
    ...
    book_reviews
      .writeTo("demo.reviewsjonas.book_reviews_urlconnection")
